...
public class EscapeGame
{
	...
	public static void main(String[] args) 
	{
		...
		for (int i = 0; i < 12; i++)
		{
			Monster sorceress = new Monster("Sorceress", 's', 60, 60, Color.PINK, 5, 60, 40, 60);
			Monster knight = new Monster("Black Knight", 'k', 100, 100, Color.DARK_GRAY, 5, 100, 120, 120);
		...
		for (int i = 0; i < 8; i++)
		{
		    ...
		    Monster wraith = new Monster("Wraith", 'W', 300, 300, Color.BLUE, 7, 200, 180, 300);
		    Monster ogre = new Monster("Ogre", 'O', 500, 500, Color.ORANGE, 4, 300, 400, 500);
		    Monster naga = new Monster("Naga", 'N', 200, 200, Color.LIGHT_GRAY, 6, 160, 80, 200);
		...
		for (int i = 0; i < 5; i++)
		{
			Monster dragon = new Monster("Red Dragon", 'D', 2000, 2000, Color.RED, 6, 500, 500, 10000);
